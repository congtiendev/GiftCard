...
{
    public const ADMIN_RESOURCE = 'Mageplaza_Affiliate::account_massinactive';
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->messageManager->addSuccessMessage(__('A total of %1 record(s) have been in activated.',
                $collectionSize));
        } catch (\Exception $e) {
